        ...
        const templateData = {
            ...
            newSale: {
                ...
                productsData: saleData.productsData.map(product => ({
                    ...
                    ourPrice: product.ourPrice ? product.ourPrice : product.price,
                    quantity: product.quantity || 0,
                    subtotal: product.subtotal || 0,
                    baseUnit: product.baseUnit || '',
                    isWeight: product.isWeight || false,
                    productCode: receiptSettings.productCode ? (product.productCode || '') : undefined,
                })),
                grandTotal: newSale.grandTotal || 0,
                totalPcs: newSale.totalPcs || 0,
                discount: receiptSettings.taxDiscountShipping ? (newSale.discountValue || 0) : undefined,
